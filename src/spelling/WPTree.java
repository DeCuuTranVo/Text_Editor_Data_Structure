...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		Queue<WPTreeNode> queueBFS = new LinkedList<WPTreeNode>(); 
		...
		while (!queueBFS.isEmpty()) {
			...
			WPTreeNode curr = queueBFS.remove();
			String currWord = curr.getWord();
			// get a list of real word neighbors (one mutation from curr's word)
			List<String> neighbors = this.nw.distanceOne(currWord, true); // false
	...
	public static void main(String[] args) {
		...
		String start = "me";
		String destination = "you";
		List<String> testPath = testTree.findPath(start, destination);
