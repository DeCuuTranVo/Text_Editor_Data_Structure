...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> wordTokenList = this.getTokens(stringPattern);
	    return wordTokenList.size();
	}
	...
	public int getNumSentences()
	{
		...
		List<String> sentenceTokenList = this.getTokens(stringPattern);
//		for (String item : sentenceTokenList) {
//			System.out.println(item);
//		}
//		System.out.println(sentenceTokenList);
	    return sentenceTokenList.size();
	}
	...
	public int getNumSyllables()
	{
		...
		String stringPattern = "[A-Za-z]+";
		List<String> wordTokenList = this.getTokens(stringPattern);
//		System.out.println(wordTokenList);
		
	    int numSyllabelsInText = 0;
	    for (String word : wordTokenList) {
	    	int numSyllablesInWord = this.countSyllables(word);
//	    	System.out.println("Outside: " +word + "->" + numSyllablesInWord);
	    	numSyllabelsInText += numSyllablesInWord;
	    }
        return numSyllabelsInText;
	}
